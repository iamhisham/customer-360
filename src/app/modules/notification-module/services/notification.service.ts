...
export class NotificationService {
  ...
  constructor(private http: HttpClient, private toastController: ToastController,
    ...
    public popoverController: PopoverController, private cookieService: CookieService, private constantService: ConstantService) {
    this.validateToken();
    this.init();
  }
  ...
  getAllCategory(params: any = {}) {
    return this.http.get<any>(`${this.URL}/cdp/notifications/categories`, { params });
  }
  ...
  getAllTemplate(params = {}) {
    return this.http.get<any>(`${this.URL}/cdp/notifications/templates`, { params });
  }
  ...
  getNotificationHistoryByUserIdWithStatus(customer_id: any, params: any) {
    return this.http.get(`${this.URL}/cdp/notifications/customers/${customer_id}/histories`, { params });
  }
  ...
  getNotificationQueueByUserIdWithStatus(customer_id: any, params: any) {
    return this.http.get(`${this.URL}/cdp/notifications/queues/customers/${customer_id}`, { params });
  }
  ...
  getAllHistoryError(params = {}) {
    return this.http.get(`${this.URL}/cdp/notifications/histories/errors`, { params });
  }
  ...
  // queue
  getAllQueue(params = {}) {
    return this.http.get(`${this.URL}/cdp/notifications/queues`, { params });
  }
