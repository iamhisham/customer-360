...
@Component({
  selector: 'app-user-based-notification-history-component',
  templateUrl: './user-based-notification-history-component.component.html',
  styleUrls: ['./user-based-notification-history-component.component.scss'],
})
export class UserBasedNotificationHistoryComponentComponent implements OnInit {
  ...
  submittedErrorNotificationList: any = {
    ...
    embed: this.constantService.USER_BASE_NOTIFICATOIN_HISTORY.GET_ALL_ERROR_DETAIL,
    ...
    buildData: (sentNotification: any) => {
      return sentNotification.map((sentNotification: any) => {
        ...
        return {
          ...
          link: {
            notification_id: '/notification-center/notification/' + sentNotification.notificationId + '/history'
          },
          action: {}
        };
      });
  ...
  submittedDeferredNotificationList: any = {
    ...
    embed: this.constantService.USER_BASE_NOTIFICATOIN_HISTORY.GET_ALL_DIFFERED_DETAIL,
    fields: [
      { name: "ID", attr: "id", width: "75" },
      { name: "Notification ID", attr: "notificationId", width: "160", type: "LINK" },
      { name: "Category", attr: "categoryName", width: "160" },
  ...
  submittedQueuedNotificationList: any = {
    ...
    embed: this.constantService.USER_BASE_NOTIFICATOIN_HISTORY.GET_ALL_QUEUED_DETAIL,
    fields: [
      { name: "ID", attr: "id", width: "75" },
      { name: "Notification ID", attr: "notificationId", width: "160", type: "LINK" },
      { name: "Category", attr: "categoryName", width: "160" },
    ...
    buildData: (submitdefer: any) => {
      return submitdefer.map((submitdefer: any) => {
        ...
        return {
          ...
          scheduledAt: this.datePipe.transform(submitdefer.scheduledAt, this.notifiService.date_time_format),
          link: {
            notificationId: submitdefer.isAbTesting ? '/notification-center/ab-testing/result/' + submitdefer.notificationId : '/notification-center/notification/' + submitdefer.notificationId + '/history'
          },
          action: {
  ...
  deliveredNotificationList: any = {
    ...
    embed: this.constantService.USER_BASE_NOTIFICATOIN_HISTORY.GET_ALL_DELIVERED_NOTIFICATION,
    fields: [
      { name: "ID", attr: "id", width: "75" },
      { name: "Notification ID", attr: "notificationId", width: "160", type: "LINK" },
      { name: "Category", attr: "categoryName", width: "160" },
  ...
  @ViewChild('errorNotification_grid') errorNotificationGrid: TableComponent | undefined;
  @ViewChild('queuedNotification_grid') queuedNotificationGrid: TableComponent | undefined;
  @ViewChild('sentNotification_grid') sentNotificationGrid: TableComponent | undefined;
  @ViewChild('deferredNotification_grid') deferredNotificationGrid: TableComponent | undefined;

  constructor(public constantService: ConstantService, private datePipe: DatePipe, public notifiService: NotificationService,
  ...
  async openErrorMsgPopup(response: any, isSuccess: boolean = false) {
    const modal = await this.modalController.create({
      component: 'RetryModalPopupComponent', //TODO
