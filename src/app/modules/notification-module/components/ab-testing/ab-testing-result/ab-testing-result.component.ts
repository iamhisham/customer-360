...
export class AbTestingResultComponent implements OnInit {
  ...
  constructor(private actRouter: ActivatedRoute, public notifiService: NotificationService, private modalController: ModalController, private alertController: AlertController) { }
