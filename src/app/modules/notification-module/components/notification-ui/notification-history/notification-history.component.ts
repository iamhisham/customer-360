...
export class NotificationHistoryComponent implements OnInit {
  ...
  constructor(public notifiService: NotificationService, private actRouter: ActivatedRoute, public commonSerice: CommonService,
    private router: Router, public datePipe: DatePipe, private alertController: AlertController) {
